...
#As per the documentation, the model ID for the image generation model is "amazon.titan-image-generator-v1"
stability_image_config = json.dumps({
    "taskType": "TEXT_IMAGE",   # Task type for text-to-image generation
    "textToImageParams": {
